...
export const WeatherPhotoChange = (convertWeatherIconObjToString) => {
    if (convertWeatherIconObjToString === 'cloudy' || convertWeatherIconObjToString === 'partlycloudy_day') {
        ...
        return sun
    } else if (convertWeatherIconObjToString.includes('heavyrain') || convertWeatherIconObjToString === 'lightrain' || convertWeatherIconObjToString === 'rain' || convertWeatherIconObjToString === 'rainshowers_day' || convertWeatherIconObjToString === 'lightrainshowers_day') {
        return rain 
